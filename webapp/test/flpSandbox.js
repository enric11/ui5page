		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GitHub Page",
									"targetURL": "#ecastellagithubpagegithubpage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ecastellagithubpagegithubpage-display": {
								"semanticObject": "ecastellagithubpagegithubpage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ecastella.githubpage.githubpage",
									"url": sap.ui.require.toUrl("ecastella/githubpage/githubpage")
								}
							}
						}
					}
